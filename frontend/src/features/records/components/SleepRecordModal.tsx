...
interface SleepRecordModalProps {
  ...
  isSaving: boolean;
  onClose: () => void;
  onSave: (record: { start: TimeValue; end: TimeValue }) => Promise<boolean>;
}

export function SleepRecordModal({ visible, isSaving, onClose, onSave }: SleepRecordModalProps) {
